function createPopup(message) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    // Use absolute URLs for external pages and relative URLs for internal ones.
    const buttonActions = {
    ...
    const projectLinks = {
      ...
      toh: './vis_story/index.html',
      home: './index.html',
      congress_tracker: './q1-congressional-activity/index.html'
    };
  
    // Set the href attributes for any project links
    ...
    // Attach click event listeners to buttons using buttonActions
      ...
      if (button) {
        button.addEventListener('click', function() {
          ...
          setTimeout(function() {
            ...
            // Navigate to the URL from buttonActions
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    dropdownLinks.forEach(link => {
      link.addEventListener('click', function (e) {
        ...
        if (href && href.trim() !== "#") {
          // If the link is relative, use it as is.
          let url = href;
