...
function enterDistrict() {
        ...
        if (userInput) {
                ...
                popup.style.cursor = "progress";
                body.style.cursor = "progress"; // Add this line to set the progress cursor for the body

                // Remove the pop-up after 3 seconds
                setTimeout(function() {
                        popup.remove();
                        body.style.cursor = "auto"; 
                        launchNewPage(userInput); // This will need to change once we determine how to display the graphs, etc
                }, 3000);
        }
}
